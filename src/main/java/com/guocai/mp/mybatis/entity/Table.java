...
public class Table {
	...
	/**
	 * 生成的Dao Implement类包路径
	 */
	private String daoPackage;
	/**
	 * 生成的daoMy类包路径
	 */
	private String daoMyPackage;

	/**
	 * 生成的参数类包路径
	 */
	private String allParameterPackage;
	...
	public void setTableDesc(String tableDesc) {
		if (tableDesc.contains("表")) {
			tableDesc = tableDesc.replace("表", "信息");
		}else {
			tableDesc = tableDesc+"信息";
		}
	...
	public String getStrutsActionAlias() {
		return Util.underlineToCamel(this.getTableName());
	}
	/**
	 * 返回基于表名的Sequence名称
	 * @return
	...
	public String getEntityName () {
		this.entityName = Util.formatFirstWordUpperCase(this.getTableName());
		return entityName;
	}
	/**
	 * 返回Entity类包路径
	...
	public String getEntityPackage() {
		this.entityPackage = "com.taikang.health.msnp.po";
	...
	public String getControllerPackage() {
		this.controllerPackage = "com.taikang.health.msnp.web";
	...
	public String getJavaMapperPackage() {
		this.javaMapperPackage = "com.taikang.health.msnp.dao.access";
	...
	public String getServicePackage() {
		this.servicePackage = "com.taikang.health.msnp.service";
	...
	public String getServiceImplPackage() {
		this.serviceImplPackage = "com.taikang.health.msnp.service.impl";
		return serviceImplPackage;
	}

	public String getDaoMyPackage() {
		this.daoMyPackage = "com.taikang.health.msnp.dao.mybatis";
		return daoMyPackage;
	}
	...
	public String getDaoPackage() {
		this.daoPackage = "com.taikang.health.msnp.dao";
		return daoPackage;
	}
	/**
	 * 返回参数类包路径
	 * @return
	 */
	public String getAllParameterPackage() {
		this.allParameterPackage = "com.taikang.health.msnp.bo";
		return allParameterPackage;
	}
