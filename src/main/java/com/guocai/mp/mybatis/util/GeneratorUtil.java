...
//			logger.debug(templateFile);
	...
	public static String getFieldJavaType(Column col) {
		...
		if(col.getDataType().equals("varchar") || col.getDataType().equals("char")) {
			javaType = "String";
		} else if (col.getDataType().equals("blob")) {
			javaType = "byte[]";
		} else if (col.getDataType().equals("date")||
				col.getDataType().startsWith("time")||
				col.getDataType().startsWith("datetime")||
				col.getDataType().startsWith("timestamp")||
				col.getDataType().startsWith("year")) {
			javaType = "Date";
		} else if (col.getDataType().equals("int")) {
			javaType = "Long";
		} else if (col.getDataType().equals("double")) {
			javaType = "Double";
		} else if (col.getDataType().equals("tinyint")) {
			javaType = "String";
		} else {
			javaType = "String";
		}
