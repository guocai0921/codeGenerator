...
public class Util {
	...
	public static String formatFirstWordUpperCase(String name) {
		String tableName = name.toLowerCase();
		String[] str = tableName.split("_");
		StringBuilder sd = new StringBuilder();
		for (int i = 0; i < str.length; i++) {
			sd.append(firstLetterToUpper(str[i]));
		}
		return sd.toString();
	}

	public static void main(String[] args) {
		System.out.println(Util.underlineToCamel("STOCK_DATA_PRIVILEGE"));
		System.out.println(Util.camelToUnderline("stockDataPrivilege"));
		System.out.println(formatFirstWordUpperCase("t_name"));
	}
}
